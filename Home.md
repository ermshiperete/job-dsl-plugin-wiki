...
If you want to get fancy you'll want to read up on the _configure_ block which gives you direct access to the config.xml, read [[configure block]]. It's also possible (and easy) to [[define your own DSL commands|Extending DSL from your scripts]] using monkey patching.
